...
public class TaskSpecification {
     ...
     */
    public static TaskSpecification every(int time, TimeUnit unit, Object plugin) {
        int t = (int) (unit.toMillis(time) / 50);
        return new TaskSpecification(t, t, true, plugin);
    }
     ...
     * @return the time specification
     */
    public static TaskSpecification everyTicks(int time, Object plugin) {
        return new TaskSpecification(time, time, true, plugin);
    }
